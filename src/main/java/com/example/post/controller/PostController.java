...
public class PostController {
    ...
    @PostMapping("/create")
    public String savePost(@ModelAttribute Post post, @SessionAttribute(name = "user") User user) {
    ...
    public String showFindByIdPost(@PathVariable(name = "id") Long id, Model model) {
        // 서비스에서 글 조회
    ...
    public String showFindAllPosts(Model model) {
